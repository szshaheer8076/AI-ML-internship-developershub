...
Methodology:
Dataset loaded via scikit-learn. Pandas used for data inspection and descriptive statistics. Visualizations created with matplotlib and 
seaborn: scatter plots (feature relationships), histograms (distributions), box plots (outlier detection via IQR method), pair plot (all feature combinations), and correlation heatmap (Pearson r).
Results:
